...
exports.getAllTecnicosHandler = exports.createTecnicoHandler = void 0;
const tecnico_service_1 = require("../../services/tecnico/tecnico.service");
...
const getAllTecnicosHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const usuarios = yield (0, tecnico_service_1.getAllTecnicos)();
        res.status(201).json({
            data: usuarios,
        });
        return;
...
exports.getAllTecnicosHandler = getAllTecnicosHandler;
