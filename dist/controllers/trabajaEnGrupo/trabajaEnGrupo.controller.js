...
exports.deleteTrabajaEnGrupoHandler = exports.getAllTrabajaEnTodosLosGruposHandler = exports.getAllTrabajaEnGrupoHandler = exports.createTrabajaEnGrupoHandler = void 0;
const trabajaEnGrupo_service_1 = require("../../services/trabajaEnGrupo/trabajaEnGrupo.service");
...
const getAllTrabajaEnGrupoHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const grupoDeTrabajoId = parseInt(req.params.grupoDeTrabajoId, 10);
        const trabajaEnGrupos = yield (0, trabajaEnGrupo_service_1.getAllWorkersInGroup)(grupoDeTrabajoId);
        res.status(200).json({
...
exports.getAllTrabajaEnGrupoHandler = getAllTrabajaEnGrupoHandler;
const getAllTrabajaEnTodosLosGruposHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield (0, trabajaEnGrupo_service_1.getAllWorkersInAllGroups)();
...
exports.getAllTrabajaEnTodosLosGruposHandler = getAllTrabajaEnTodosLosGruposHandler;
