...
exports.ubicacionTecnica = (0, pg_core_1.pgTable)('UbicacionTecnica', {
    ...
    abreviacion: (0, pg_core_1.varchar)('abreviacion', { length: 5 }).notNull(),
    codigo_Identificacion: (0, pg_core_1.varchar)('codigo_identificacion', {
        length: 50,
    })
        .unique()
        .notNull(),
    nivel: (0, pg_core_1.integer)('nivel').notNull(),
    estaHabilitado: (0, pg_core_1.boolean)('esta_habilitado').default(true).notNull(),
